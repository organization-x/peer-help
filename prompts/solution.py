...
def solution_model(string):
    ...
    try:
        response = openai.Completion.create(
            ...
            prompt = f"The following paragraph is the solution statement of a product specification. Evaluate how well the solution statement has been written and give specific feedback on what can be improved. Write several in-depth sentences.\n{string}",
            temperature = 0.1,
            max_tokens = 512,
            top_p = 1,
            frequency_penalty = 0,
